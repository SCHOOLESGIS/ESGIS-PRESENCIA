...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $users = [
            ...
            ['name' => 'Michael', 'surname' => 'Johnson', 'email' => 'michael.johnson@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'Emily', 'surname' => 'Williams', 'email' => 'emily.williams@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'David', 'surname' => 'Davis', 'email' => 'david.davis@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'James', 'surname' => 'Wilson', 'email' => 'james.wilson@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'Sophia', 'surname' => 'Jackson', 'email' => 'sophia.jackson@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'Ethan', 'surname' => 'Clark', 'email' => 'ethan.clark@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'Olivia', 'surname' => 'Anderson', 'email' => 'olivia.anderson@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'Isabella', 'surname' => 'Harris', 'email' => 'isabella.harris@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'Benjamin', 'surname' => 'Young', 'email' => 'benjamin.young@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'Charlotte', 'surname' => 'Walker', 'email' => 'charlotte.walker@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'William', 'surname' => 'White', 'email' => 'william.white@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'Matthew', 'surname' => 'Taylor', 'email' => 'matthew.taylor@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'Alexander', 'surname' => 'Roberts', 'email' => 'alexander.roberts@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'Daniel', 'surname' => 'Thomas', 'email' => 'daniel.thomas@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'Sarah', 'surname' => 'Miller', 'email' => 'sarah.miller@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'Benjamin', 'surname' => 'Moore', 'email' => 'benjamin.moore@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
            ['name' => 'bend', 'surname' => 'do', 'email' => 'bend.do@example.com', 'password' => bcrypt('password'), 'role' => 'enseignant'],
        ];
        ...
        $enseignants = [
            ['user_id' => 1, 'speciality' => 'Informatique'],
            ['user_id' => 2, 'speciality' => 'Réseaux et Télécom'],
            ['user_id' => 3, 'speciality' => 'Cybersécurité'],
            ['user_id' => 4, 'speciality' => 'Systèmes Embarqués'],
            ['user_id' => 5, 'speciality' => 'Intelligence Artificielle'],
            ['user_id' => 6, 'speciality' => 'Big Data'],
            ['user_id' => 7, 'speciality' => 'Robotique'],
            ['user_id' => 8, 'speciality' => 'Développement Web'],
            ['user_id' => 9, 'speciality' => 'Développement Mobile'],
            ['user_id' => 10, 'speciality' => 'Game Development'],
            ['user_id' => 11, 'speciality' => 'Data Science'],
            ['user_id' => 12, 'speciality' => 'Cloud Computing'],
            ['user_id' => 13, 'speciality' => 'Blockchain'],
            ['user_id' => 14, 'speciality' => 'DevOps'],
            ['user_id' => 15, 'speciality' => 'Systèmes Embarqués'],
            ['user_id' => 16, 'speciality' => 'Machine Learning'],
            ['user_id' => 17, 'speciality' => 'Informatique'],
            ['user_id' => 18, 'speciality' => 'Réseaux et Télécom'],
            ['user_id' => 19, 'speciality' => 'Cybersécurité'],
            ['user_id' => 20, 'speciality' => 'Data Science'],
        ];
